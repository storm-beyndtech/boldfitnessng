		...
		>
			...
			<div className="w-full max-w-[520px] flex flex-col gap-10">
				<p className="text-[#D0D5DC]/50 leading-8">
					<span className="font-medium text-[#D0D5DC] sm:text-sm">Exercises:</span> Elevate your fitness and
					...
					{exercises.map((exercise, i) => (
						<div key={i} className="w-[100%] flex flex-col gap-4">
							<div className="flex justify-between">
								<h3 className="text-[#D0D5DC] font-medium text-sm sm:text-lg leading-[2]">
									{exercise.title}
								</h3>
							...
							<p className="text-[11px] sm:text-sm font-medium max-sm:font-normal text-[#D0D5DC]/50 leading-6">
								{exercise.desc}
							</p>
						</div>
					))}
